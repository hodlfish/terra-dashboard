function Icons() {
    return <svg xmlns="http://www.w3.org/2000/svg" style={{height: 0, width: 0, position: 'absolute', visibility: 'hidden'}}>
        <defs>
            ...
            <symbol id="calculator" width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M6 29H26V3H6V29ZM24 5H8V9H24V5ZM8.5 14.5C7.67157 13.6716 7.67157 12.3284 8.5 11.5C9.32843 10.6716 10.6716 10.6716 11.5 11.5C12.3284 12.3284 12.3284 13.6716 11.5 14.5C10.6716 15.3284 9.32843 15.3284 8.5 14.5ZM17.5 11.5C16.6716 10.6716 15.3284 10.6716 14.5 11.5C13.6716 12.3284 13.6716 13.6716 14.5 14.5C15.3284 15.3284 16.6716 15.3284 17.5 14.5C18.3284 13.6716 18.3284 12.3284 17.5 11.5ZM23.5 11.5C22.6716 10.6716 21.3284 10.6716 20.5 11.5C19.6716 12.3284 19.6716 13.6716 20.5 14.5C21.3284 15.3284 22.6716 15.3284 23.5 14.5C24.3284 13.6716 24.3284 12.3284 23.5 11.5ZM11.5 17.5C10.6716 16.6716 9.32843 16.6716 8.5 17.5C7.67157 18.3284 7.67157 19.6716 8.5 20.5C9.32843 21.3284 10.6716 21.3284 11.5 20.5C12.3284 19.6716 12.3284 18.3284 11.5 17.5ZM11.5 23.5C10.6716 22.6716 9.32843 22.6716 8.5 23.5C7.67157 24.3284 7.67157 25.6716 8.5 26.5C9.32843 27.3284 10.6716 27.3284 11.5 26.5C12.3284 25.6716 12.3284 24.3284 11.5 23.5ZM17.5 17.5C16.6716 16.6716 15.3284 16.6716 14.5 17.5C13.6716 18.3284 13.6716 19.6716 14.5 20.5C15.3284 21.3284 16.6716 21.3284 17.5 20.5C18.3284 19.6716 18.3284 18.3284 17.5 17.5ZM17.5 23.5C16.6716 22.6716 15.3284 22.6716 14.5 23.5C13.6716 24.3284 13.6716 25.6716 14.5 26.5C15.3284 27.3284 16.6716 27.3284 17.5 26.5C18.3284 25.6716 18.3284 24.3284 17.5 23.5ZM20.5 17.5C21.3284 16.6716 22.6716 16.6716 23.5 17.5C24.3284 18.3284 24.3284 19.6716 23.5 20.5C22.6716 21.3284 21.3284 21.3284 20.5 20.5C19.6716 19.6716 19.6716 18.3284 20.5 17.5ZM23.5 23.5C22.6716 22.6716 21.3284 22.6716 20.5 23.5C19.6716 24.3284 19.6716 25.6716 20.5 26.5C21.3284 27.3284 22.6716 27.3284 23.5 26.5C24.3284 25.6716 24.3284 24.3284 23.5 23.5Z"/>
            </symbol>
        </defs> 
    </svg>;
}
