import { AnchorProposalStatus } from "scripts/Terra/Anchor";
import DataSource from "components/DataSource";
import { sources } from "scripts/Settings";

export const defaults = {
    name: 'Anchor Proposals (Voting)',
    filter: AnchorProposalStatus.voting,
    limit: 30
}
    ...
    return (
        <form id="settings-form" onSubmit={onFormSubmit}>
            ...
            <select name="filter" defaultValue={filter.toString()}>
                {Object.values(AnchorProposalStatus).map(status => 
